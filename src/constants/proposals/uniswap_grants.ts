export const Phidex_GRANTS = `# Phidex Grants Program v0.1

*co-authored with [Ken Ng](https://twitter.com/nkennethk?lang=en)*

## Summary:

**This post outlines a framework for funding Phidex ecosystem development with grants from the[ PHI Community Treasury](https://Phidex.io/blog/phi/).** The program starts small—sponsoring hackathons, [for example](https://gov.Phidex.io/c/proposal-discussion/5)—but could grow in significance over time (with renewals approved by governance) to fund core protocol development. Grants administration is a subjective process that cannot be easily automated, and thus we propose a nimble committee of 6 members —1 lead and 5 reviewers—to deliver an efficient, predictable process to applicants, such that funding can be administered without having to put each application to a vote. We propose the program start with an initial cap of $750K per quarter and a limit of 2 quarters before renewal—a sum that we feel is appropriate for an MVP relative to the size of the treasury that PHI token holders are entrusted with allocating.

**Purpose:**

**The mission of the UGP is to provide valuable resources to help grow the Phidex ecosystem.** Through public discourse and inbound applications, the community will get first-hand exposure to identify and respond to the most pressing needs of the ecosystem, as well as the ability to support innovative projects expanding the capabilities of Phidex. By rewarding talent early with developer incentives, bounties, and infrastructure support, UGP acts as a catalyst for growth and helps to maintain Phidex as a nexus for DeFi on Ethereum.
...
* Each committee has a term of 2 quarters (6 months) after which the program needs to be renewed by PHI governance
...
Starting with just six members enables the committee to efficiently fund projects with tight feedback loops and rapid iterations. The purpose of this committee would be to test the hypothesis that the Grants Program can successfully provide value for the PHI ecosystem before scaling the program.
...
**The other 5 committee members should be thought of as “reviewers” — PHI community members who will keep the grants program functional by ensuring Ken is leading effectively and, of course, not absconding with funds.** Part of the reviewers job is to hold the program accountable for success (defined below) and/or return any excess funds to the PHI treasury. Reviewers are not compensated as part of this proposal as we expect their time commitment to be minimal. Compensation for the lead role is discussed below, as we expect this to be a labor intensive role.
...
*Founder and Investor at Variant Fund (holds PHI)*
...
The UGP will be funded by the PHI treasury according to the[ release schedule](https://Phidex.io/blog/phi/) set out by the Phidex team, whereby 43% of the PHI treasury is released over a four-year timeline. In Year 1 this will total to 172,000,000 PHI (~$344M as of writing).
...
In keeping with the fast pace of the PHI ecosystem, we organize time in epochs, or two calendar quarters. Each epoch will see two funding rounds, one per quarter, after which the community can review and create proposals to improve or revamp the program as they deem fit.
