import { JSBI, Token } from '@Phidex/sdk'
...
export default function MigrateV1() {
  ...
  const V1LiquidityTokens: Token[] = useMemo(() => {
    return chainId
      ? Object.keys(V1Exchanges).map(exchangeAddress => new Token(chainId, exchangeAddress, 18, 'PHI-V1', 'Phidex V1'))
      : []
  }, [chainId, V1Exchanges])
    ...
    <BodyWrapper style={{ padding: 24 }}>
      <AutoColumn gap="16px">
        ...
        <TYPE.body style={{ marginBottom: 8, fontWeight: 400 }}>
          For each pool shown below, click migrate to remove your liquidity from Phidex V1 and deposit it into Phidex
          V2.
        </TYPE.body>
