import { JSBI, Token, TokenAmount } from '@Phidex/sdk'
...
export function computePHICirculation(
  PHI: Token,
  blockTimestamp: BigNumber,
  unclaimedPHI: TokenAmount | undefined
): TokenAmount {
  ...
  const total = new TokenAmount(PHI, JSBI.multiply(wholeAmount, JSBI.exponentiate(JSBI.BigInt(10), JSBI.BigInt(18))))
  return unclaimedPHI ? total.subtract(unclaimedPHI) : total
}
